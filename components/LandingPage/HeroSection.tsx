      ...
      <div className="mx-auto flex w-10/12">
        <div className="space-y-4 text-gray-200">
          ...
          <Paragraph className="text-sm">
            Join AuthorJunction and share your writing with the world! Our platform is
            designed for small authors who want to showcase their work and connect with
            readers. Whether you write poetry, short stories, or novels, you can join our
